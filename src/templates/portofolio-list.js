...
export const PortofolioListQuery = graphql`
  query PortofolioListQuery($skip: Int!, $limit: Int!) {
    allMarkdownRemark(
      sort: { order: DESC, fields: [frontmatter___date] }
      filter: { frontmatter: { template: { eq: "portofolio-post" } } }
      limit: $limit
      skip: $skip
		) {
      edges {
...
class BlogIndex extends React.Component {
  render() {
    ...
    return (
      <Layout className="portofolio-page">
        <SEO
          title={"Portofolio — Page " + currentPage + " of " + numPages}
