...
const Pagination = (props) => (
  ...
  >
    <ul>
        {(props.previous && props.previous.frontmatter.template === 'portofolio-post') && (
          <li>
        ...
        {(props.next && props.next.frontmatter.template === 'portofolio-post') && (
          <li>
  ...
  return (
    <Layout className="page">
      ...
      <article className="portofolio-post">
        ...
        <div
          className="portoflio-post-content"
...
export const pageQuery = graphql`
  query PortofolioPostQuery($id: String!) {
    markdownRemark( 
      id: { eq: $id }
    ) {
      id
